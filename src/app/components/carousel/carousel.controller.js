...
angular
  ...
  .controller('CarouselCtrl', [function () {
    ...
    self.slides = [
      {
        id: 1,
        img: '/assets/images/backgrounds/headfold-station.png',
        text1: '東南亞移工為台灣社會帶來了多元種族、文化與價值觀。',
        text2: '在他們勇敢跨越國界實踐夢想的路上，我們應該推上一把。'
      },
      {
        id: 2,
        img: '/assets/images/backgrounds/headfold-students.png',
        text1: '培養國際觀不用天天出國，只要用對的心態看待從東南亞來的移工，',
        text2: '生活周遭就是你認識世界的場域。'
      },
      {
        id: 3,
        img: '/assets/images/backgrounds/headfold-chapel.png',
